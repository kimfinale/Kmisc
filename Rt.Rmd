...
params <- c(beta = R0/5, epsilon = 1/2.5, delta = 1/5, 
            gamma = 1/2.5, bp = 1, ba = 1, fa = 0.3, frac_detect = 1)
...
d <- data.frame(date = dat$time, 
                daily_confirmed = round(dat$stoch_perfect_obs$confirmed[, id]))
